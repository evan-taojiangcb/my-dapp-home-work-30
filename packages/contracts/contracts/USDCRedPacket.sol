...
/// @title USDCRedPacket
/// @notice A red-packet (hongbao) contract that locks ERC-20 tokens (USDC) and lets
///         recipients claim their share. Supports equal and pseudo-random distribution.
/// @dev    Pseudo-random distribution is for demonstration only. In production use
